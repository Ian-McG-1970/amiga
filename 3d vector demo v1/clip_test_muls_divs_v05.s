...
DEBUG_CLIP_TEST_WRITE_3D
			MOVE.L 	(BK_CLIP_START_ROT_X),D0
			move.L	#(180*40)+0,d1
			BSR		HEX32
			MOVE.L 	(BK_CLIP_START_ROT_Y),D0
			move.L	#(180*40)+9,d1
			BSR		HEX32
			MOVE.L 	(BK_CLIP_START_ROT_Z),D0
			move.L	#(180*40)+18,d1
			BSR		HEX32

			MOVE.L 	(BK_CLIP_END_ROT_X),D0
			move.L	#(186*40)+0,d1
			BSR		HEX32
			MOVE.L 	(BK_CLIP_END_ROT_Y),D0
			move.L	#(186*40)+9,d1
			BSR		HEX32
			MOVE.L 	(BK_CLIP_END_ROT_Z),D0
			move.L	#(186*40)+18,d1
			BSR		HEX32

			MOVE.L 	(BK_CLIPPED_ROT_X),D0
			move.L	#(192*40)+0,d1
			BSR		HEX32
			MOVE.L 	(BK_CLIPPED_ROT_Y),D0
			move.L	#(192*40)+9,d1
			BSR		HEX32
			MOVE.L 	(BK_CLIPPED_ROT_Z),D0
			move.L	#(192*40)+18,d1
			BSR		HEX32
...
BACKUP_IN	MOVE.L	D0,(BK_CLIP_START_ROT_X)
			MOVE.L 	D1,(BK_CLIP_START_ROT_Y)
			MOVE.L 	D2,(BK_CLIP_START_ROT_Z)
			MOVE.L	D3,(BK_CLIP_END_ROT_X)
			MOVE.L 	D4,(BK_CLIP_END_ROT_Y)
			MOVE.L 	D5,(BK_CLIP_END_ROT_Z)
			RTS

BACKUP_OUT	MOVE.L	D0,(BK_CLIPPED_ROT_X)
			MOVE.L 	D1,(BK_CLIPPED_ROT_Y)
			MOVE.L 	D2,(BK_CLIPPED_ROT_Z)
			RTS
...
BK_CLIP_START_ROT_X	DS.L	1
BK_CLIP_START_ROT_Y	DS.L	1
BK_CLIP_START_ROT_Z	DS.L	1

BK_CLIP_END_ROT_X		DS.L	1
BK_CLIP_END_ROT_Y		DS.L	1
BK_CLIP_END_ROT_Z		DS.L	1

BK_CLIPPED_ROT_X		DS.L 	1
BK_CLIPPED_ROT_Y		DS.L 	1
BK_CLIPPED_ROT_Z		DS.L 	1
