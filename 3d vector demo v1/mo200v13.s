...
TEST_NUMBER		DC.L 255
TEST_NUMBER_Z	DC.L 255
TEST_NUMBER_PROJ1 DC.L 255
TEST_NUMBER_PROJ2 DC.L 255
TEST_NUMBER_PROJ3 DC.L 255
SIDE_X		dc.w	0
SIDE_Y		dc.w	0
...
;			move.l 	#100,d1
;			move.l 	#100,d2
;			BSR project_v2	;d0=z d1=x d3=years
...
;			ext.l	d1
			move.w	YOFFSET,D1
;			ext.l	d2
			BSR 	PERSPECTIVE ;_NEW ; d2=z do=x d1=y ; project_v3	;d0=z d1=x d3=years

			MOVE.L	D2,TEST_NUMBER_PROJ2
			move.l	d1,d0
			moveq.l	#27,d1
			BSR		HEX32

			MOVE.L	TEST_NUMBER_PROJ2,D0
			moveq.l	#36,d1
			BSR		HEX32

			MOVE.L	TEST_NUMBER_PROJ1,D0
			moveq.l	#50,d1
			BSR		HEX32
			MOVE.L	TEST_NUMBER_PROJ3,D0
			moveq.l	#60,d1
			BSR		HEX32
...
PROJECT_END MACRO
			...
			bne.s	.neg1
				...
				bra.s	.cont8
.neg1		move.w	#SCREEN_VER_MIDDLE,d0
			sub.w	d1,d0
			move.w	d0,d1
.cont8
			move.w SIDE_Y,D0
			TST.w	D0
			bne.s	.neg2
				ADD.w	#SCREEN_HOR_MIDDLE,D2
				rts
.neg2		move.w	#SCREEN_HOR_MIDDLE,d0
			sub.w	d2,d0
			move.w	d0,d2
			rts
			ENDM

PROJECT_31:	LSR.L	#8,D0	;LSR.L 	#24,d0
			LSR.L	#8,D0
			LSR.L	#8,D0
			LSR.L 	#8,d1	;LSR.L 	#16,d1
			LSR.L 	#8,d1
			LSR.L 	#8,d2	;LSR.L 	#16,d2
			LSR.L 	#8,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#31,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_30:	LSR.L	#8,D0	;LSR.L 	#23,d0
			LSR.L	#8,D0
			LSR.L	#7,D0		
			LSR.L 	#8,d1	;LSR.L 	#15,d1
			LSR.L 	#7,d1
			LSR.L 	#8,d2	;LSR.L 	#15,d2
			LSR.L 	#7,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#30,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_29:	LSR.L	#8,D0	;LSR.L 	#22,d0
			LSR.L	#8,D0
			LSR.L	#6,D0		
			LSR.L 	#8,d1	;LSR.L 	#14,d1
			LSR.L 	#6,d1
			LSR.L 	#8,d2	;LSR.L 	#14,d2
			LSR.L 	#6,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#29,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_28:	LSR.L	#8,D0	;LSR.L 	#21,d0
			LSR.L	#8,D0
			LSR.L	#5,D0		
			LSR.L 	#8,d1	;LSR.L 	#13,d1
			LSR.L 	#5,d1
			LSR.L 	#8,d2	;LSR.L 	#13,d2
			LSR.L 	#5,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#28,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_27:	LSR.L	#8,D0	;LSR.L 	#20,d0
			LSR.L	#8,D0
			LSR.L	#4,D0		
			LSR.L 	#8,d1	;LSR.L 	#12,d1
			LSR.L 	#4,d1
			LSR.L 	#8,d2	;LSR.L 	#12,d2
			LSR.L 	#4,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#27,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_26:	LSR.L	#8,D0	;LSR.L 	#19,d0
			LSR.L	#8,D0
			LSR.L	#3,D0
			LSR.L 	#8,d1	;LSR.L 	#11,d1
			LSR.L 	#3,d1
			LSR.L 	#8,d2	;LSR.L 	#11,d2
			LSR.L 	#3,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#26,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_25:	LSR.L	#8,D0	;LSR.L 	#18,d0
			LSR.L	#8,D0
			LSR.L	#2,D0
			LSR.L 	#8,d1	;LSR.L 	#10,d1
			LSR.L 	#2,d1
			LSR.L 	#8,d2	;LSR.L 	#10,d2
			LSR.L 	#2,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#25,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_24:	LSR.L	#8,D0	;LSR.L 	#17,d0
			LSR.L	#8,D0
			LSR.L	#1,D0
			LSR.L 	#8,d1	;LSR.L 	#9,d1
			LSR.L 	#1,d1
			LSR.L 	#8,d2	;LSR.L 	#9,d2
			LSR.L 	#1,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#24,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_23:	LSR.L	#8,D0	;LSR.L 	#16,d0
			LSR.L	#8,D0
			LSR.L 	#8,d1
			LSR.L 	#8,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#23,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_22:	LSR.L	#8,D0	;LSR.L 	#15,d0
			LSR.L	#7,D0
			LSR.L 	#7,d1
			LSR.L 	#7,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#22,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_21:	LSR.L	#8,D0	;LSR.L 	#14,d0
			LSR.L	#6,D0
			LSR.L 	#6,d1
			LSR.L 	#6,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#21,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_20:	LSR.L	#8,D0	;LSR.L 	#13,d0
			LSR.L	#5,D0
			LSR.L 	#5,d1
			LSR.L 	#5,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#20,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_19:	LSR.L	#8,D0	;LSR.L 	#12,d0
			LSR.L	#4,D0
			LSR.L 	#4,d1
			LSR.L 	#4,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#19,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_18:	LSR.L	#8,D0	;LSR.L 	#11,d0
			LSR.L	#3,D0
			LSR.L 	#3,d1
			LSR.L 	#3,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#18,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_17:	LSR.L	#8,D0	;LSR.L 	#10,d0
			LSR.L	#2,D0
			LSR.L 	#2,d1
			LSR.L 	#2,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#17,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_16:	LSR.L	#8,D0	;LSR.L 	#9,d0
			LSR.L	#1,D0
			LSR.L 	#1,d1
			LSR.L 	#1,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#16,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_15:	LSR.L 	#8,d0
;			LSR.L 	#16,d1
;			LSR.L 	#16,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#15,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_14:	LSR.L 	#7,d0
			LSl.L 	#1,d1
			LSl.L 	#1,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#14,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_13:	LSR.L 	#6,d0
			LSl.L 	#2,d1
			LSl.L 	#2,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#13,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_12:	LSR.L 	#5,d0
			LSl.L 	#3,d1
			LSl.L 	#3,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#12,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_11:	LSR.L 	#4,d0
			LSl.L 	#4,d1
			LSl.L 	#4,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#11,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_10:	LSR.L 	#3,d0
			LSl.L 	#5,d1
			LSl.L 	#5,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#10,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_09:	LSR.L 	#2,d0
			LSl.L 	#6,d1
			LSl.L 	#6,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#9,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_08:	LSR.L 	#1,d0
			LSl.L 	#7,d1
			LSl.L 	#7,d2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#8,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_07:
;	LSR.L 	#24,d0
			...
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#7,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_06:	LSl.L 	#1,d0
			LSL.L	#8,D1	;LSL.L 	#9,d1
			LSL.L	#1,D1
			LSL.L	#8,D2	;LSL.L 	#9,d2
			LSL.L	#1,D2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#6,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_05:	LSl.L 	#2,d0
			LSL.L	#8,D1	;LSL.L 	#10,d1
			LSL.L	#2,D1
			LSL.L	#8,D2	;LSL.L 	#10,d2
			LSL.L	#2,D2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#5,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_04:	LSl.L 	#3,d0
			LSL.L	#8,D1	;LSL.L 	#11,d1
			LSL.L	#3,D1
			LSL.L	#8,D2	;LSL.L 	#11,d2
			LSL.L	#3,D2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#4,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_03:	LSl.L 	#4,d0
			LSL.L	#8,D1	;LSL.L 	#12,d1
			LSL.L	#4,D1
			LSL.L	#8,D2	;LSL.L 	#12,d2
			LSL.L	#4,D2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#3,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_02:	LSl.L 	#5,d0
			LSL.L	#8,D1	;LSL.L 	#13,d1
			LSL.L	#5,D1
			LSL.L	#8,D2	;LSL.L 	#13,d2
			LSL.L	#5,D2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#2,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_01:	LSL.L 	#6,d0
			LSL.L	#8,D1	;LSL.L 	#14,d1
			LSL.L	#6,D1
			LSL.L	#8,D2	;LSL.L 	#14,d2
			LSL.L	#6,D2
			divu	d0,d1
			divu 	d0,d2
			...
			PROJECT_END
			RTS
PROJECT_00:	LSL.L 	#7,d0
			LSL.L	#8,D1	;LSL.L 	#15,d1
			LSL.L	#7,D1
			LSL.L	#8,D2	;LSL.L 	#15,d2
			LSL.L	#7,D2
			divu	d0,d1
			divu 	d0,d2
			MOVE.L	#0,TEST_NUMBER_Z
			PROJECT_END
			RTS

PROJECT_JMP	MACRO
			move.l	d3,TEST_NUMBER_PROJ1
			lea 	PROJECT_TAB,a4
			add.w	d3,d3
			add.w	d3,d3
			move.l	(a4,d3.w),A4
...
c2	MOVE.w	d3,SIDE_Y
	...
	cmp.l 	#$0000FFFF,d0	; high word set?
	bgt.s	project_1631	; high word is populated
project_0015:
	move.l 	d0,TEST_NUMBER_PROJ3
	move.b	(a4,d0.w),d3	; get low word
	PROJECT_JMP
	rts
project_1631:
	swap	d0
	move.l 	d0,TEST_NUMBER_PROJ3
	move.b	(a4,d0.w),d3	; get high word
	or.b 	#16,d3			; add 16
	PROJECT_JMP
	rts

project_v2:	;d0=z d1=x d3=years
	moveq.l	#0,d3			; clear word of result

	move.l	d0,d4			; $hhmmbbll
	swap	d4				; $hhmmbbll becomes $bbllhhmm
	tst.w	d4				; is $hhmm eq 0000?
	beq		project0015		; yes

project1631:					; $hhmm must ne $0000
	move.w	d4,d3			; backup
	lsr.w	#8,d4			; $hhmm becomes $00hh
	tst.b	d4				; is $hh eq 00?
	beq.s	project1623		; yes

project2431:					; $hh ne $00
	lea bit_set_tabs_hh,a1
	move.b	(a1,d4.w),d3	; get hh bit set
	MOVE.L	#$77,TEST_NUMBER_Z
	PROJECT_JMP
	rts

project1623:					; $mm ne $00
	lea bit_set_tabs_mm,a1
	move.b	(a1,d3.w),d3	; get mm bit set
	MOVE.L	#$55,TEST_NUMBER_Z
	PROJECT_JMP
	rts

project0015:					; $bbll must ne 0000
	move.w	d4,d3			; backup
	lsr.w	#8,d4			; $bbll becomes $00bb
	tst.b	d4				; is $bb eq 00?
	beq.s	project0007		; yes

project0815:					; $bb must ne $00
	lea bit_set_tabs_bb,a1
	move.b	(a1,d4.w),d3	; get bb bit set
	MOVE.L	#$33,TEST_NUMBER_Z
	PROJECT_JMP
	rts

project0007:					;
	lea bit_set_tabs_ll,a1
	move.b	(a1,d3.w),d3	; get ll bit set
	move.l	d3,TEST_NUMBER
	MOVE.L	#$99,TEST_NUMBER_Z
	PROJECT_JMP
	rts

bit_set_tab:			; are these tables the wrong way around? should they start at 0 and end at 32768?
	dcb.b	1,0
	dcb.b	1,0
	dcb.b	2,1
	dcb.b	4,2
...
;	dc.l pers_31
;	...
;	dc.l	pers_07,pers_06,pers_05,pers_04,pers_03,pers_-2,pers_01,pers_00
	
;pers31	shift right xy 16
;		shift right z 24
;
;pers30	shift right xy 14
;		shift right z 22
;pers29	shift right xy 14
;		shift right z 22
;...
;pers17	shift right xy 2
;		shift right z 10
;pers16	shift right xy 1
;		shift right z 9
;
;pers15	shift right z 8
;pers14	shift left xz 1
;		right right z 7
;pers13	shift left xz 2
;		right right z 6
;...
;pers07	shift left xz 8
;
;pers06	shift left xz 9
;		shift left z 1
;pers05	shift left xz 10
;		shift left z 2
;...
;pers01	shift left xz 15
;		shift left z 7
;pers00	error?
...
PROJECT_TAB	DC.L 	PROJECT_00,PROJECT_01,PROJECT_02,PROJECT_03,PROJECT_04,PROJECT_05,PROJECT_06,PROJECT_07
			DC.L 	PROJECT_08,PROJECT_09,PROJECT_10,PROJECT_11,PROJECT_12,PROJECT_13,PROJECT_14,PROJECT_15
			DC.L 	PROJECT_16,PROJECT_17,PROJECT_18,PROJECT_19,PROJECT_20,PROJECT_21,PROJECT_22,PROJECT_23
			DC.L 	PROJECT_24,PROJECT_25,PROJECT_26,PROJECT_27,PROJECT_28,PROJECT_29,PROJECT_30,PROJECT_31
