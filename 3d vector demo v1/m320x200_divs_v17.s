...
;			BSR		HEX32
			...
			MOVE.l 	(TEST3),D0		; D_Diff
			move.l	#(48*40)+0,d1
			BSR		HEX32
			MOVE.l 	(TEST4),D0		; S_Diff
			move.l	#(48*40)+9,d1
			BSR		HEX32
			MOVE.l 	(TESTB),D0		; 
			move.l	#(48*40)+18,d1
			...
			MOVE.l 	(TEST5),D0		; D_x * S_Diff
			move.l	#(186*40)+0,d1
			BSR		HEX32
			MOVE.l 	(TEST6),D0		; / D_Diff
			move.l	#(186*40)+9,d1
			BSR		HEX32

			MOVE.l 	(TEST7),D0		; D_y * S_Diff
			move.l	#(192*40)+0,d1
			BSR		HEX32			; / D_Diff
			MOVE.l 	(TEST8),D0
			move.l	#(192*40)+9,d1
...
.CLIP_RIGHT_END:				; end point is off right
	...
	MOVE.L D0,(TEST_Z1)
							...
							MOVE.L 	D2,(CLIPPED_ROT_X)
							MOVE.L 	D1,(CLIPPED_ROT_Y)
							MOVE.L 	D0,(CLIPPED_ROT_Z)
	MOVE.L D2,(TEST_X2)
	MOVE.L D1,(TEST_Y2)
	MOVE.L D0,(TEST_Z2)
