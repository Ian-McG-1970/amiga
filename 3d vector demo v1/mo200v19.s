...
PROJECT_END MACRO
			...
			bpl.s	.pos1
				neg.w	d1
.pos1		ADD.w	#SCREEN_VER_MIDDLE,D1
			move.l	a5,d4
			TST.l	d4
			bpl.s	.pos2
				neg.w	D0
.pos2		ADD.w	#SCREEN_HOR_MIDDLE,d0
			rts
			ENDM

PROJECT_31:	LSR.L	#8,d2	;LSR.L 	#24,d2
			LSR.L	#8,d2
			LSR.L	#8,d2
			LSR.L 	#8,d1	;LSR.L 	#16,d1
			LSR.L 	#8,d1
			LSR.L 	#8,d0	;LSR.L 	#16,d0
			LSR.L 	#8,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#31,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_30:	LSR.L	#8,d2	;LSR.L 	#23,d2
			LSR.L	#8,d2
			LSR.L	#7,d2		
			LSR.L 	#8,d1	;LSR.L 	#15,d1
			LSR.L 	#7,d1
			LSR.L 	#8,d0	;LSR.L 	#15,d0
			LSR.L 	#7,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#30,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_29:	LSR.L	#8,d2	;LSR.L 	#22,d2
			LSR.L	#8,d2
			LSR.L	#6,d2		
			LSR.L 	#8,d1	;LSR.L 	#14,d1
			LSR.L 	#6,d1
			LSR.L 	#8,d0	;LSR.L 	#14,d0
			LSR.L 	#6,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#29,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_28:	LSR.L	#8,d2	;LSR.L 	#21,d2
			LSR.L	#8,d2
			LSR.L	#5,d2		
			LSR.L 	#8,d1	;LSR.L 	#13,d1
			LSR.L 	#5,d1
			LSR.L 	#8,d0	;LSR.L 	#13,d0
			LSR.L 	#5,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#28,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_27:	LSR.L	#8,d2	;LSR.L 	#20,d2
			LSR.L	#8,d2
			LSR.L	#4,d2		
			LSR.L 	#8,d1	;LSR.L 	#12,d1
			LSR.L 	#4,d1
			LSR.L 	#8,d0	;LSR.L 	#12,d0
			LSR.L 	#4,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#27,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_26:	LSR.L	#8,d2	;LSR.L 	#19,d2
			LSR.L	#8,d2
			LSR.L	#3,d2
			LSR.L 	#8,d1	;LSR.L 	#11,d1
			LSR.L 	#3,d1
			LSR.L 	#8,d0	;LSR.L 	#11,d0
			LSR.L 	#3,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#26,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_25:	LSR.L	#8,d2	;LSR.L 	#18,d2
			LSR.L	#8,d2
			LSR.L	#2,d2
			LSR.L 	#8,d1	;LSR.L 	#10,d1
			LSR.L 	#2,d1
			LSR.L 	#8,d0	;LSR.L 	#10,d0
			LSR.L 	#2,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#25,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_24:	LSR.L	#8,d2	;LSR.L 	#17,d2
			LSR.L	#8,d2
			LSR.L	#1,d2
			LSR.L 	#8,d1	;LSR.L 	#9,d1
			LSR.L 	#1,d1
			LSR.L 	#8,d0	;LSR.L 	#9,d0
			LSR.L 	#1,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#24,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_23:	LSR.L	#8,d2	;LSR.L 	#16,d2
			LSR.L	#8,d2
			LSR.L 	#8,d1
			LSR.L 	#8,d0
			divu	d2,d1
...
;			MOVE.L	#23,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_22:	LSR.L	#8,d2	;LSR.L 	#15,d2
			LSR.L	#7,d2
			LSR.L 	#7,d1
			LSR.L 	#7,d0
			divu	d2,d1
...
;			MOVE.L	#22,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_21:	LSR.L	#8,d2	;LSR.L 	#14,d2
			LSR.L	#6,d2
			LSR.L 	#6,d1
			LSR.L 	#6,d0
			divu	d2,d1
...
;			MOVE.L	#21,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_20:	LSR.L	#8,d2	;LSR.L 	#13,d2
			LSR.L	#5,d2
			LSR.L 	#5,d1
			LSR.L 	#5,d0
			divu	d2,d1
...
;			MOVE.L	#20,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_19:	LSR.L	#8,d2	;LSR.L 	#12,d2
			LSR.L	#4,d2
			LSR.L 	#4,d1
			LSR.L 	#4,d0
			divu	d2,d1
...
;			MOVE.L	#19,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_18:	LSR.L	#8,d2	;LSR.L 	#11,d2
			LSR.L	#3,d2
			LSR.L 	#3,d1
			LSR.L 	#3,d0
			divu	d2,d1
...
;			MOVE.L	#18,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_17:	LSR.L	#8,d2	;LSR.L 	#10,d2
			LSR.L	#2,d2
			LSR.L 	#2,d1
			LSR.L 	#2,d0
			divu	d2,d1
...
;			MOVE.L	#17,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_16:	LSR.L	#8,d2	;LSR.L 	#9,d2
			LSR.L	#1,d2
			LSR.L 	#1,d1
			LSR.L 	#1,d0
			divu	d2,d1
...
;			MOVE.L	#7,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_06:	LSl.L 	#1,d2
			LSL.L	#8,D1	;LSL.L 	#9,d1
			LSL.L	#1,D1
			LSL.L	#8,d0	;LSL.L 	#9,d0
			LSL.L	#1,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#6,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_05:	LSl.L 	#2,d2
			LSL.L	#8,D1	;LSL.L 	#10,d1
			LSL.L	#2,D1
			LSL.L	#8,d0	;LSL.L 	#10,d0
			LSL.L	#2,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#5,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_04:	LSl.L 	#3,d2
			LSL.L	#8,D1	;LSL.L 	#11,d1
			LSL.L	#3,D1
			LSL.L	#8,d0	;LSL.L 	#11,d0
			LSL.L	#3,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#4,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_03:	LSl.L 	#4,d2
			LSL.L	#8,D1	;LSL.L 	#12,d1
			LSL.L	#4,D1
			LSL.L	#8,d0	;LSL.L 	#12,d0
			LSL.L	#4,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#3,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_02:	LSl.L 	#5,d2
			LSL.L	#8,D1	;LSL.L 	#13,d1
			LSL.L	#5,D1
			LSL.L	#8,d0	;LSL.L 	#13,d0
			LSL.L	#5,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#2,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_01:	LSL.L 	#6,d2
			LSL.L	#8,D1	;LSL.L 	#14,d1
			LSL.L	#6,D1
			LSL.L	#8,d0	;LSL.L 	#14,d0
			LSL.L	#6,d0
			divu	d2,d1
			divu 	d2,d0
;			MOVE.L	#1,TEST_NUMBER_Z
			PROJECT_END
			RTS
PROJECT_00:	LSL.L 	#7,d2
			LSL.L	#8,D1	;LSL.L 	#15,d1
			LSL.L	#7,D1
			LSL.L	#8,d0	;LSL.L 	#15,d0
			LSL.L	#7,d0
			divu	d2,d1
			divu 	d2,d0
...
.c2			lea 	bit_set_tab,a4
			moveq.l	#0,d3			; clear long word of result
			cmp.l 	#$0000FFFF,d2	; high word set?
			bgt.s	project_hi		; high word is populated
project_lo:		move.b	(a4,d2.w),d3		; get low word
				lea 	PROJECT_TAB_LO,a4
				add.w	d3,d3
				add.w	d3,d3
				move.l	(a4,d3.w),A4
				jmp		(a4)
...
PROJECT_TAB_LO	DC.L 	PROJECT_00,PROJECT_01,PROJECT_02,PROJECT_03,PROJECT_04,PROJECT_05,PROJECT_06,PROJECT_07,PROJECT_08,PROJECT_09,PROJECT_10,PROJECT_11,PROJECT_12,PROJECT_13,PROJECT_14,PROJECT_15
PROJECT_TAB_HI	DC.L 	PROJECT_16,PROJECT_17,PROJECT_18,PROJECT_19,PROJECT_20,PROJECT_21,PROJECT_22,PROJECT_23,PROJECT_24,PROJECT_25,PROJECT_26,PROJECT_27,PROJECT_28,PROJECT_29,PROJECT_30,PROJECT_31
